...
[/docs/2026-07-28/develop/build-server](/docs/2026-07-28/develop/build-server)

### Build clients
Develop applications that connect to MCP servers
[/docs/2026-07-28/develop/build-client](/docs/2026-07-28/develop/build-client)

### Build MCP Apps
Build interactive apps that run inside AI clients
[/extensions/apps/overview](/extensions/apps/overview)

## Learn more

### Understand concepts
Learn the core concepts and architecture of MCP
[/docs/2026-07-28/learn/architecture](/docs/2026-07-28/learn/architecture)

---

*Source: [modelcontextprotocol.io](https://modelcontextprotocol.io/llms.txt)*